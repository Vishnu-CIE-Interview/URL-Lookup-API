...
def alert_critical_errors_on_email():
    ...
    mail_handler = SMTPHandler(
        ...
        fromaddr=os.getenv('SNMP_FROM_ADDRESS'),
        toaddrs=os.getenv('SNMP_TO_ADDRESS'),
...
def app_function():
    ...
    # the template is used to initialize API Spec documentation and populate information that is accessible at http://<api-server-ip>:port/apidocs
    template = {
        "swagger": "2.0",
        "info": {
